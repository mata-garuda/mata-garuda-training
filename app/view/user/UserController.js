Ext.define('Xtion.view.user.UserController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.user',

    requires: [
        'Xtion.view.user.UserCreate'
    ],

    onAddClick: function (sender, record) {

        var x = Ext.getCmp('userTab');

        var t = x.items.findBy(
            function (tab){
                return tab.id === 'user_tab_add';
            });
    ...
    loadViewActionbar: function () {
        ...
        var actionbar = Ext.getCmp("useractionbar");
    ...
    save: function () {
        ...
        var form   = Ext.getCmp('userTab').getComponent('user_tab_add');
