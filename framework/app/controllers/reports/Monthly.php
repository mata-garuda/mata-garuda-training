...
class Monthly extends REST_Controller{
	private function filter_builder($filter_sensor, $filter_date, $filter_ip_src, $filter_ip_dst){
		$filter = "";
		$filter .= " date between '".$filter_date."-01' and '".$filter_date."-31'";
		//$filter .= "date_format(date, '%c') = $filter_month";
	...
	public function total_event_get(){
		...
		$result = $this->Report_model->monthly_total_event($filter);
	...
	public function by_sig_get($type = "table"){
		...
		$result = $this->Report_model->monthly_report_by_sig($filter);
	...
	public function by_severity_get($type = "table"){
		...
		$result = $this->Report_model->monthly_report_by_severity($filter);
	...
	public function by_proto_get(){
		...
		$result = $this->Report_model->monthly_report_by_proto($filter);
	...
	public function by_top_tcp_src_get(){
		...
		$result = $this->Report_model->monthly_report_by_top_tcp_src($filter);
	...
	public function by_top_tcp_dst_get(){
		...
		$result = $this->Report_model->monthly_report_by_top_tcp_dst($filter);
	...
	public function by_top_ucp_dst_get(){
		...
		$result = $this->Report_model->monthly_report_by_top_udp_dst($filter);
	...
	public function by_top_ucp_src_get(){
		...
		$result = $this->Report_model->monthly_report_by_top_udp_src($filter);
	...
	public function by_ip_src_get($type = "table"){
		...
		$result = $this->Report_model->monthly_report_by_ip_src($filter);
	...
	public function by_ip_dst_get($type = "table"){
		...
		$result = $this->Report_model->monthly_report_by_ip_dst($filter);
