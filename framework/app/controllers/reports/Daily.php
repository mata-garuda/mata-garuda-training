...
class Daily extends REST_Controller{
	private function filter_builder($filter_sensor, $filter_date, $filter_ip_src, $filter_ip_dst, $filter_enddate = null){
		$filter = "";

		if($filter_enddate == null){
			$filter .= "date = '$filter_date'";
		}else{
			$filter .= "date between '$filter_date' and '$filter_enddate'";
		}
	...
	public function total_event_get(){
		...
		$filter = $this->filter_builder($filter_sensor, $filter_date, $filter_ip_src, $filter_ip_dst, $filter_enddate);	

		$this->load->model('Report_model');
		
		$result = $this->Report_model->daily_total_event($filter);
	...
	public function by_sig_get($type = "table"){
		$filter_date = $this->input->get("date");
		$filter_enddate = $this->input->get("enddate");
		$filter_sensor = $this->input->get("sensor") ? $this->input->get("sensor") : null;
		$filter_ip_src = $this->input->get("src") ? $this->input->get("src") : null;
		$filter_ip_dst = $this->input->get("dst") ? $this->input->get("dst") : null;
		...
		$result = $this->Report_model->daily_report_by_sig($filter);
	...
	public function by_severity_get($type = "table"){
		...
		$result = $this->Report_model->daily_report_by_severity($filter);
	...
	public function by_proto_get(){
		...
		$result = $this->Report_model->daily_report_by_proto($filter);
	...
	public function by_top_tcp_src_get(){
		...
		$result = $this->Report_model->daily_report_by_top_tcp_src($filter);
	...
	public function by_top_tcp_dst_get(){
		...
		$result = $this->Report_model->daily_report_by_top_tcp_dst($filter);
	...
	public function by_top_ucp_dst_get(){
		...
		$result = $this->Report_model->daily_report_by_top_udp_dst($filter);
	...
	public function by_top_ucp_src_get(){
		...
		$result = $this->Report_model->daily_report_by_top_udp_src($filter);
	...
	public function by_ip_src_get($type = "table"){
		...
		$result = $this->Report_model->daily_report_by_ip_src($filter);
	...
	public function by_ip_dst_get($type = "table"){
		...
		$result = $this->Report_model->daily_report_by_ip_dst($filter);
